...
AI 先生成一条用户能直接读懂的核心理解，再显示一条不确定信息；不输出长篇“解梦文章”。完整依据按需展开，所有推断使用概率语言，并显示信息来源。
...
首屏最多显示三个行动项。点击“补充”后不新开流程，而是在当前草稿下展开 AI 对话输入区；原理解保持可见，用户可自由打字或语音补充梦境细节、修正理解或说明现实联系。AI 最多追问 1-2 次，用户点击“完成补充”后回到同一份草稿，再由“很贴近”确认是否保存。
